...
namespace _Game.Source.Application.PlacementSystem.Factories
{
    ...
    public class BuildingFactoryBase : IFactory<BuildingDataComponent, BuildingParams>
    {
        ...
        public BuildingFactoryBase(Dictionary<BuildingType, BuildingDataComponent> buildingPrefabsDataBase, BuildingState initialState, IObjectResolver objectResolver, Transform container)
        {
        ...
        {
            var instance = _objectResolver.Instantiate(prefab, _container);

...
namespace _Game.Scripts.Application.PlacementSystem.Factories
{
    ...
    {
        public BuildingFactory(Dictionary<BuildingType, BuildingDataComponent> buildingPrefabsDataBase, IObjectResolver resolver) : base(buildingPrefabsDataBase, resolver)
        {
        }
